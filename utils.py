...
def plot(X, meta_regrets, exp3_regrets, moss_regrets, exp3_reset_regrets, title, xlabel, ylabel):
...
def switches_exp(N_EXPS, N_SWITCHES, N_BANDITS, HORIZON, N_UNBIASED_OBS, ALG_NAME, OPT_SIZE, N_EXPERT, DS_NAME, quiet=True, **kwargs):
    ...
    exp3_caches, exp3_reset_caches, moss_caches, meta_caches = [], [], [], []
    ...
    plot(X[indices], meta_regrets[:,indices], exp3_regrets[:,indices], moss_regrets[:,indices], exp3_reset_regrets[:,indices], title, xlabel, ylabel)
    return (X, meta_regrets, exp3_regrets, moss_regrets, exp3_reset_regrets, title, xlabel, ylabel)
...
def horizon_exp(N_EXPS, N_SWITCHES, N_BANDITS, N_UNBIASED_OBS, ALG_NAME, OPT_SIZE, N_EXPERT, DS_NAME, horizon_list = np.arange(1,202,50)*10, quiet=True, **kwargs):
    ...
    plot(X, meta_regrets_h, exp3_regrets_h, moss_regrets_h, exp3_reset_regrets_h, title, xlabel, ylabel)
    return (X, meta_regrets_h, exp3_regrets_h, moss_regrets_h, exp3_reset_regrets_h, title, xlabel, ylabel)
...
def arm_exp(N_EXPS, N_SWITCHES, HORIZON, N_UNBIASED_OBS, ALG_NAME, OPT_SIZE, N_EXPERT, DS_NAME, n_bandits_list = np.arange(8,69,15), quiet=True, **kwargs):
    exp3_caches_b, exp3_reset_caches_b, moss_caches_b, meta_caches_b = [], [], [], []
    ...
    plot(X, meta_regrets_b, exp3_regrets_b, moss_regrets_b, exp3_reset_regrets_b, title, xlabel, ylabel)
    return (X, meta_regrets_b, exp3_regrets_b, moss_regrets_b, exp3_reset_regrets_b, title, xlabel, ylabel)
...
def experts_exp(N_EXPS, N_SWITCHES, N_BANDITS, HORIZON, N_UNBIASED_OBS, ALG_NAME, OPT_SIZE, DS_NAME, n_experts_list = None, quiet=True, **kwargs):
    ...
    exp3_caches_e, exp3_reset_caches_e, moss_caches_e, meta_caches_e = [], [], [], []
    ...
    plot(X, meta_regrets_e, exp3_regrets_e, moss_regrets_e, exp3_reset_regrets_e, title, xlabel, ylabel)
    return (X, meta_regrets_e, exp3_regrets_e, moss_regrets_e, exp3_reset_regrets_e, title, xlabel, ylabel)
...
def subgroup_size_exp(N_EXPS, N_SWITCHES, N_BANDITS, HORIZON, N_UNBIASED_OBS, ALG_NAME, N_EXPERT, DS_NAME, opt_size_list = None, quiet=True, **kwargs):
    ...
    exp3_caches_s, exp3_reset_caches_s, moss_caches_s, meta_caches_s = [], [], [], []
    ...
    plot(X, meta_regrets_s, exp3_regrets_s, moss_regrets_s, exp3_reset_regrets_s, title, xlabel, ylabel)
    return (X, meta_regrets_s, exp3_regrets_s, moss_regrets_s, exp3_reset_regrets_s, title, xlabel, ylabel)
